...
# Read Image
library(EBImage)
Image1 <- readImage("F:\\Data Science\\Kaggle\\Image Processing\\pic4.jpg")
Image2 <- readImage("F:\\Data Science\\Kaggle\\Image Processing\\pic1.jpg")
...
# New image file
setwd("F:\\Data Science\\Kaggle\\Image Processing")
writeImage(d, "NewImage.jpg")
